                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" placeholder="Address" value=""
                                                            class="form-control form-control-sm" name="address" required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" placeholder="Your Occupation" value=""
                                                            class="form-control form-control-sm" name="occupation" required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <select name="marital" class="form-control form-control-sm" required
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <select name="fstatus" class="form-control form-control-sm" required
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <select name="mstatus" class="form-control form-control-sm" required
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <input type="checkbox" required style="width:20px; height: 20px"> I
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-xlg-3 col-md-5">
                                    <div class="card">
                                        <div class="card-body">
                                            <center class="m-t-30">
                                                <img src={{ asset('profiles/' . $bio->image) }} class="rounded-circle"
                                                    width="150" />
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <dl>
                                                            ...
                                                            <dd>{{ $bio->bio->relationship }} {{ $bio->bio->id }}</dd>
                                                        </dl>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-sm-12">
                                                            <a name="" id="" data-toggle="modal" data-target="#editRequest"
                                                                ...
                                                                <form id="editbioemail">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title font-14">Request Form
                                                                                for Names Data</h5>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="">
                                                                                    ...
                                                                                    <small class="text-primary">
                                                                                        ...
                                                                                        <b>Bio Data Details. e.g (Next Of
                                                                                            Kin: Name...)</b>
                                                                                    </small>
                                                                                </label>
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button id="submit-email" type="submit"
                                                                                ...
                                                                                Send Request <i class="fa fa-paper-plane"
                                                                                    aria-hidden="true"></i>
                                                                            </button>
                                                                        </div>
                                                                    </div>
