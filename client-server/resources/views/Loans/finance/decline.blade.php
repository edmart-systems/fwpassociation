<div class="modal fade" id="finance-decline" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <form id="decline-loan">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group font-14 col-md-12 col-sm-12">
                            ...
                            <textarea type="text" id="finance_decline_res" name="finance_decline_res"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" btn-id="" btn-action="save" id="decline-finance-btn"
