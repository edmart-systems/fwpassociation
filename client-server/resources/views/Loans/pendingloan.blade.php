                                    ...
                                    <tbody>
                                        @foreach ($loans as $loan)
                                            <tr>
                                                ...
                                                <div class="modal fade" id="finance-rerecommend-{{ $loan['id'] }}"
                                                    ...
                                                    <div class="modal-dialog modal-md modal-dialog-centered"
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title font-15" id="loansTitle">Rerecommend
                                                                    Loan</h5>
                                                                <button type="button" class="close"
                                                                    data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group font-14 col-md-12 col-sm-12">
                                                                            ...
                                                                            <textarea type="text" id="finance_rerecommend_res" name="finance_Rerecommend_res"
                                                                                ...
                                                                                rows="5"></textarea>
                                                                            <input type="hidden" id="rerecommend_id_holder"
                                                                                value="{{ $loan['id'] }}" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="modal fade" id="finance-decline-{{ $loan['id'] }}"
                                                    data-backdrop="static" tabindex="-1" role="dialog"
                                                    aria-labelledby="loansTitle" aria-hidden="true">
                                                    <div class="modal-dialog modal-md modal-dialog-centered"
                                                        role="document">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <div class="form-group font-14 col-md-12 col-sm-12">
                                                                            ...
                                                                            <textarea type="text" id="finance_decline_res" name="finance_decline_res" class="form-control form-control-sm desc"
                                                                                required maxlength="250"
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu px-1 hadow-lg bg-white"
                                                            ...
                                                            @if ($loan['status'] == 'clarify')
                                                                <a class="mt-1 dropdown-item text-success"
                                                                    data-toggle="modal"
                                                                    data-target="#finance-rerecommend-{{ $loan['id'] }}"
                                                                    href="#">
                                                                    <i class="fa fa-check-circle" aria-hidden="true"></i>
                                                                    Rerecommend
                                                                </a>
                                                            @else
                                                                <a class="mt-1 dropdown-item text-success recommend-finance-btn"
                                                            ...
                                                            <a class="mt-1 text-danger dropdown-item" href="#"
                                                                data-toggle="modal"
                                                                data-target="#finance-decline-{{ $loan['id'] }}">
                                                                <i class="fa fa-ban" aria-hidden="true"></i>
                                                                Decline
                                                            </a>
                                                        </div>
                                                ...
                                                <td>
                                                    @if ($loan['status'] === 'pending')
                                                        <h5>
                                                            <strong class="badge badge-pill badge-primary">Pending</strong>
                                                        </h5>
                                                    @endif
                                                    @if ($loan['status'] === 'clarify')
                                                        <h5>
                                                            <strong
                                                                class="badge badge-pill badge-secondary">Clarify</strong>
                                                        </h5>
                                                    @endif
                                                </td>
                                                <td>
