    ...
    <div class="page-wrapper adjust" style="min-height: 78vh;">
        <div class="page-breadcrumb">
            <div class="row align-items-center">
                <div class="col-5">
                    <h4 class="page-title">All Pending Expenses</h4>
                        ...
                        <table id="example" class="table hover table-bordered" width="100%" data-page-length="10">
                            ...
                            <tbody>
                                @foreach ($expenses as $expense)
                                    <tr>
                                        <td>
                                            @if ((Auth()->user()->userType === 'treasurer') && $expense->status!="approved" && $expense->status!="cancelled")
                                                <div class="dropdown">
                                                    <button
                                    ...
                                    <div class="modal" id="delete{{ $expense['id'] }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title font-14">RECOMMEND EXPENSE FOR
                                                ...
                                                <form method="POST" action="{{ route('expenseAction') }}">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group text-center">
                                                            ...
                                                            <h4 class="text-warning">Are You sure you want to Recommend this
                                                                Expense !</h2>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-outline-primary btn-sm"><i
                                                                class="fa fa-check" aria-hidden="true"></i> Recommend</button>
                                                    </div>
                                                </form>
